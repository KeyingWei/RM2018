...
{  
    ...
    {  
        ...
        DMA_ClearFlag(DMA1_Stream5,DMA_FLAG_TCIF1 | DMA_FLAG_FEIF1 | DMA_FLAG_DMEIF1 | DMA_FLAG_TEIF1 | DMA_FLAG_HTIF1); //clear DMA flag
        DMA_SetCurrDataCounter(DMA1_Stream5, AHRS_RC_LEN);  			
        DMA_Cmd(DMA1_Stream5, ENABLE); 
