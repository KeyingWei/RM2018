...
void MPU6500_GetMotion6(int16_t* ax, int16_t* ay, int16_t* az, int16_t* gx, int16_t* gy, int16_t* gz)
{
  ...
  MPU6500_Lastgz = mpu_buff[12]<<8 |mpu_buff[13] - imu_data_offest.gz;
	...
	*gx = MPU6500_FIFO[3][10] + 56; //Gx_offset;
	*gy = MPU6500_FIFO[4][10] - 6;
	*gz = MPU6500_FIFO[5][10] + 3;
	gy_data=*gz;
		...
		int16_t* az, int16_t* gx, int16_t* gy, int16_t* gz)
{
	...
	*ay  =MPU6500_FIFO[1][10];
	*az = MPU6500_FIFO[2][10];
	*gx  =MPU6500_FIFO[3][10] - Gx_offset;
	*gy = MPU6500_FIFO[4][10] - Gy_offset;
	*gz = MPU6500_FIFO[5][10] - Gz_offset;
}
