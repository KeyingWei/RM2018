...
{
	YawControl.Encoder_Init = 7979  ;//获取初始码盘值 R2:7787  R3:6313
	  YawControl.Position_kp = 15.5f;//设定位置环控制参数
	  YawControl.Velocity_kp = 23.0f;//设定速度环控制参数
	
	PitchControl.Encoder_Init = 6144         ;  // R2:6955   R3:409          ;	
	  PitchControl.Position_kp = -20.5f;
	  PitchControl.Velocity_kp = 22.0f;	
}
